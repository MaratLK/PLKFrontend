document.addEventListener('DOMContentLoaded', async () => {
    ...
    form.addEventListener("submit", async (event) => {
        ...
        formData.append("datePublished", new Date(document.getElementById("news-date").value).toISOString());
        formData.append("content", document.getElementById("news-description").value);
